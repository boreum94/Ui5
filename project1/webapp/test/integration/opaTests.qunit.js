...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "code/d22/project1/test/integration/FirstJourney",
    "code/d22/project1/test/integration/ZC_TFED22ListJourney",
    "code/d22/project1/test/integration/ZC_TFED22ObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
